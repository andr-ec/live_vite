defmodule LiveVite.E2E.ReactEventReplyTestLive do
  @moduledoc false
  ...
  def render(assigns) do
    ...
    <div>
      ...
      <LiveVite.react
        id="react-event-reply-component"
        counter={@counter}
        v-component="react_event_reply_test"
        v-socket={@socket}
      />
    </div>
    """
  ...
  # Event that returns different data types
